...
import com.example.myapplication.databinding.FragmentNovoProdutoBinding
class NovoProdutoFragment : Fragment() {
    ...
    private fun cancelar() {
        findNavController().navigate(R.id.action_novoProdutoFragment_to_ListaStockFragment)
    }
